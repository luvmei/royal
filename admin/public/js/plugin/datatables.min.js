      ...
      (v = t),
        ...
        (this.fnGetData = function (t, e) {
          var n,
            a = this.api(!0);
          return t !== N
            ? ((n = t.nodeName ? t.nodeName.toLowerCase() : ''), e !== N || 'td' == n || 'th' == n ? a.cell(t, e).data() : a.row(t).data() || null)
            : a.data().toArray();
        }),
  ...
  function st(t, e, n, a) {
    ...
    if (e)
      for (r = e.length - 1; 0 <= r; r--)
        for (
          var u, c = (u = e[r]).target !== N ? u.target : u.targets !== N ? u.targets : u.aTargets, f = 0, d = (c = Array.isArray(c) ? c : [c]).length;
          f < d;
          f++
        )
    ...
    for (Array.isArray(f) && e(f), d && f.pre && e(f.pre), e(t.aaSorting), d && f.post && e(f.post), n = 0; n < h.length; n++)
      for (r = (o = c[(s = h[n][(a = 0)])].aDataSort).length; a < r; a++)
        (l = c[(i = o[a])].sType || 'string'),
          h[n]._id === N && (h[n]._id = P.inArray(h[n][1], c[i].asSorting)),
          u.push({ src: s, col: i, dir: h[n][1], index: h[n]._id, type: l, formatter: C.ext.type.order[l + '-pre'] });
    return u;
  }
  function ie(t) {
    var e,
      ...
      n && t.oFeatures.bSortMulti
        ? -1 !== (i = P.inArray(e, H(l, '0')))
          ? null === (o = null === (o = r(l[i], !0)) && 1 === l.length ? 0 : o)
            ? l.splice(i, 1)
            : ((l[i][1] = s[o]), (l[i]._id = o))
          : (l.push([e, s[0], 0]), (l[l.length - 1]._id = 0))
        : l.length && l[0][0] == e
        ? ((o = r(l[0])), (l.length = 1), (l[0][1] = s[o]), (l[0]._id = o))
        : ((l.length = 0), l.push([e, s[0]]), (l[0]._id = 0)),
      u(t),
